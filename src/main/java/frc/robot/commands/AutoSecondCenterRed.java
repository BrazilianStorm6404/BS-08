...
public class AutoSecondCenterRed extends SequentialCommandGroup {

    Shooter  sb_shooter;
    Conveyor sb_conveyor;
    Intake   sb_intake;

    public AutoSecondCenterRed (Swerve sb_swerve, Shooter shooter, Conveyor conveyor, Intake intake) {
